...
#NEW with ValueError warning
dine_safe_TO = pd.read_csv(dataset_url)  

try:
    # Attempt to create DataFrame from the CSV file at the specified uploaded URL
    dine_safe_TO = pd.read_csv(dataset_url)
except Exception as e:
    e.add_note("Ensure that a valid url is current and functional.")
